...
class LaptopAdvisor:
    ...
    def _get_full_recommendation(self, products: List[Dict]) -> str:
        ...
        prompt = (
            "Ты эксперт по выбору ноутбуков. Выбери лучший вариант из списка и обоснуй выбор кратко на русском языке.\n"
            ...
            "ВАЖНО: Все цены должны быть указаны в ДОЛЛАРАХ ($), а не в евро или рублях!\n"
            "Учитывай:\n"
    ...
    def _compare_products(self, indices: List[int]) -> str:
        ...
        prompt = (
            "Сравни следующие ноутбуки на русском языке и дай рекомендацию кратко:\n"
    ...
    def process_command(self, user_input: str) -> str:
        ...
        if user_input_lower in ["выход", "exit", "quit", "пока"]:
            return "exit"
...
def main():
    ...
    print("Примеры доступных команд:")
